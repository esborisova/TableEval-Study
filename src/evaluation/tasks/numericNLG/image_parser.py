...
def parse(samples):
    ...
    for sample in samples:
        ...
        #inputs.append([image.copy(), f'Describe the given table focusing on the insights and trends revealed by the results. The summary should be concise, factual, and well-written. Do not introduce new information or speculate.'])
