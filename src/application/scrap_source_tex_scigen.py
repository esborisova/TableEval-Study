...
def main():
    data_paths = ["../../data/SciGen/test-CL/test_CL_all_meta_all_formats_2024_11_25.hf", 
                 "../../data/SciGen/test-Other/test_Other_all_meta_all_formats_2024_11_25.hf"]
    
    dowload_paths = ["../../data/SciGen/test-Other/latex_source_code/", 
    ...
    for data_path, download_path in zip(data_paths, dowload_paths):
        ...
        arxiv_ids = list(set(scigen_data.loc[scigen_data["venue"] == "arxiv", "paper_id"]))

        for paper_id in arxiv_ids:
            download_arxiv_source(paper_id, download_path)

    unzip_save_paths = ["../../../data/SciGen/test-CL/latex_source_code/unzipped/", 
