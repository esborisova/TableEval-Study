...
The SciGen data is saved as a JSON file with two keys added to each item:
...
def main():
    ...
    for key, value in data.items():
        ...
        try:
            table_code = process_arxiv_paper(arxiv_id, caption)
            if table_code:
                extracted_latex_tables.append((key, table_code))
    ...
    # Add extractef info to the data and save a new JSON file
